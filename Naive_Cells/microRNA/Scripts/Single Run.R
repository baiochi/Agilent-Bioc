...
single.run("Targets.txt",
			file.path="/Users/Baiochi/Dropbox/USP/Lab/Naive.iTreg.miRNA",
...
single.run <- function(target.file,
	...
	cat("contrast matrix...\n")
	contrast <- c("Naive-Teff", "Naive-iTreg", "Teff-iTreg")
	contrast.matrix <- makeContrasts("Naive-Teff", "Naive-iTreg", "Teff-iTreg", levels=design)
