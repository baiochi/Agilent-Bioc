---
title: "Microarray Analysis Naive-iTregs cells"
author: "João Baiochi, baiochi@usp.br"
...
The follow intensities is from AFE ProcessedSignal:   
...
```{r densityPlot, fig.align='center', warning=FALSE}
par(mfrow=c(1,1))
...
```{r , eval=FALSE, bgCorrect, results='hide'}
...
Now its possible to extract the results for each coefficient from the analysis:  
```{r topTable}
# iTreg vs Naive
...
```
**iTreg vs Naive**  
Up regulated: `r summary(rank)[1,1]` transcripts  
Down regulated: `r summary(rank)[3,1]` transcripts  
**iTreg vs Teff**  
Up regulated: `r summary(rank)[1,2]` transcripts  
Down regulated: `r summary(rank)[3,2]` transcripts  
**Naive vs Teff**  
Up regulated: `r summary(rank)[1,3]` transcripts  
Down regulated: `r summary(rank)[3,3]` transcripts  
